...
/// <summary>
/// Unit tests for <see cref="ConflictOverviewRuler.PointerYToLine"/>. The pixel→line
/// math is the load-bearing part of the overview ruler — a click on a
/// marker must land on the line that marker represents, exactly, so that
/// "click the red tick at the top to jump to conflict #1" works. Renamed
/// from ConflictMinimapTests in V6 once the 12 px tick-strip role was
/// recognised as an overview ruler rather than a content minimap.
/// </summary>
public class ConflictOverviewRulerTests
{
    [Fact]
    public void PointerYToLine_ClickAtTop_ReturnsFirstLine()
    {
        // A tall minimap with 100 lines → each row is 4 px. Y=0 is line 1.
        ConflictOverviewRuler.PointerYToLine(0, actualHeight: 400, lineCount: 100).Should().Be(1);
    }
    ...
    public void PointerYToLine_ClickAtMiddle_ReturnsMiddleLine()
    {
        ...
        // (floor(200/4)+1 = 51).
        ConflictOverviewRuler.PointerYToLine(200, actualHeight: 400, lineCount: 100).Should().Be(51);
    }
    ...
    public void PointerYToLine_ClickPastBottom_ClampsToLastLine()
    {
        ...
        ConflictOverviewRuler.PointerYToLine(99999, actualHeight: 400, lineCount: 100).Should().Be(100);
    }

    [Fact]
    public void PointerYToLine_NegativeY_ClampsToFirstLine()
    {
        ConflictOverviewRuler.PointerYToLine(-50, actualHeight: 400, lineCount: 100).Should().Be(1);
    }
    ...
    public void PointerYToLine_DenseCase_RowHeightPinsTo1Px()
    {
        ...
        ConflictOverviewRuler.PointerYToLine(10, actualHeight: 50, lineCount: 100).Should().Be(11);
    }
    ...
    public void PointerYToLine_ZeroLineCount_ReturnsOne()
    {
        ...
        ConflictOverviewRuler.PointerYToLine(50, actualHeight: 400, lineCount: 0).Should().Be(1);
    }
    ...
    public void PointerYToLine_ZeroHeight_ReturnsOne()
    {
        ...
        ConflictOverviewRuler.PointerYToLine(50, actualHeight: 0, lineCount: 100).Should().Be(1);
    }
    ...
    public void PointerYToLine_SparseCase_HitsExactRow(double y, int lineCount, int expected)
    {
        ...
        ConflictOverviewRuler.PointerYToLine(y, actualHeight: 100, lineCount: lineCount)
            .Should().Be(expected);
    }
    ...
    public void PointerYToLine_BoundaryOnRowEdge_RoundsDown()
    {
        ...
        ConflictOverviewRuler.PointerYToLine(40, actualHeight: 400, lineCount: 100)
            .Should().Be(11);
    }
}
