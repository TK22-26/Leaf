...
public class FakeGitService : IGitService
{
    ...
    public Task<string> CloneAsync(string url, string localPath, string? credentialKey = null, IProgress<string>? progress = null) => Task.FromResult("");
    public Task FetchAsync(string repoPath, string remoteName = "origin", string? credentialKey = null, IProgress<string>? progress = null) => Task.CompletedTask;
    public Task PullAsync(string repoPath, string? credentialKey = null, IProgress<string>? progress = null) => Task.CompletedTask;
    public Task PushAsync(string repoPath, string? remoteName = null, string? credentialKey = null, IProgress<string>? progress = null) => Task.CompletedTask;
    ...
    public Task<string> GetRefToRefDiffAsync(string repoPath, string baseRef, string headRef, string? filePath = null) => Task.FromResult("");
    ...
    public Task DeleteRemoteBranchAsync(string repoPath, string remoteName, string branchName, string? credentialKey = null) => Task.CompletedTask;
    ...
    public Task PushTagAsync(string repoPath, string tagName, string remoteName = "origin", string? credentialKey = null) => Task.CompletedTask;
    public Task DeleteRemoteTagAsync(string repoPath, string tagName, string remoteName = "origin", string? credentialKey = null) => Task.CompletedTask;
