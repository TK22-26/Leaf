...
/// <summary>
/// Ken Perlin's improved noise function ported to C#.
/// Used for organic wind variation and natural randomness.
/// </summary>
public static class PerlinNoise
{
    ...
    /// <summary>
    /// Fractal Brownian Motion: layers multiple octaves for richer organic variation.
    /// </summary>
    public static double FBM(double x, double y, int octaves = 4, double lacunarity = 2.0, double persistence = 0.5)
    {
        double total = 0;
        double amplitude = 1;
        double frequency = 1;
